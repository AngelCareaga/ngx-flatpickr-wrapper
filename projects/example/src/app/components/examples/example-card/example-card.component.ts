// ./projects/example/src/app/components/examples/example-card/example-card.component.ts
      ...
      <div class="space-y-6">
        ...
        @if (isCodeShown()) {
          <div class="rounded-xl overflow-hidden animate-slide-up">
            <pre class="!m-0"><code [languages]="['xml', 'typescript']" [highlight]="code"></code></pre>
          </div>
        }
      </div>
    </div>
